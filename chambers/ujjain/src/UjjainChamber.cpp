...
//
// Ujjain profile removes recirculation and adds a heater policy, disabled for bench tests.
// ============================================================================
...
#else
#define UJJAIN_TELEMETRY_URL ""
#define UJJAIN_TELEMETRY_TOKEN ""
#endif
...
// FIRMWARE IDENTITY
// ============================================================================
#define FW_VERSION          "0.2.0-ujjain-bench"
#define FW_DEVICE_FAMILY    "germination-chamber-ujjain-v1"
#define FW_BUILD_ID         __DATE__ " " __TIME__
#define DEFAULT_DEVICE_NAME "SHUNYA-UJJAIN-001"
...
void telemetryTask(void* context) {
  ...
  if (http.begin(client, UJJAIN_TELEMETRY_URL)) {
    http.addHeader("Content-Type", "application/json");
    http.addHeader("Authorization", String("Bearer ") + UJJAIN_TELEMETRY_TOKEN);
...
void serviceTelemetry(uint32_t now) {
  if (!UJJAIN_TELEMETRY_URL[0] || !UJJAIN_TELEMETRY_TOKEN[0] || telemetryBusy ||
