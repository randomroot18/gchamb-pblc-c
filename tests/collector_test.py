...
with tempfile.TemporaryDirectory() as td:
    env = dict(os.environ,JEN_DEVICE_TOKEN='a'*40,JEN_ADMIN_PASSWORD='b'*24)
    ...
    try:
        ...
        payload.update(device_id='ABCDEF123456',family='germination-chamber-jen-v1',fw='0.2.0-jen-bench',epoch=int(time.time()))
